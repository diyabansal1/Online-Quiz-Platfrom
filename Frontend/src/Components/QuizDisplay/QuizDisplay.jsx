        ...
        <>
            <div className='min-h-screen'>
                {showResult ? (
                    ...
                    <>
                        <div className='text-center m-4 text-white bg-[#f28482]  rounded-lg'>Timer :{timer == 0 || timer ? timer : " "} seconds</div>
                        <div action='' className='flex justify-center my-4'>
                            <div className='w-full max-w-screen-md h-full flex flex-col justify-center items-center gap-2 p-4'>
                                ...
                                {quizData && (
                                    <div className='w-full border-2 rounded-lg bg-[#f28482]  p-5'>
                                            ...
                                            {quizData.options.map((option, index) => (
                                                <div className='flex items-center ' key={index} >
                                                    ...
                                                    <button className={`w-full border rounded-md h-10 mb-4 text-center text-md text-white ${selectedOption == index ? "bg-red-700 border-none" : null
                                                        }   hover:bg-[#bc4749] hover:border-none`}
                                        ...
                                        <div className='text-center'>
                                            <button
                                                ...
                                                className='bg-[#f28482] hover:bg-[#bc4749] text-white font-bold py-2 px-4 rounded-md transition duration-300 ease-in-out'>
                                                Next
                                            </button>
                                        </div>
                                    </div>
