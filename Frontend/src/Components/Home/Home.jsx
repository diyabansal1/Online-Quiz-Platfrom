...
function Home() {
  ...
  return (
    <>
      <div className=" min-h-screen bg-[#f08080]">
        <div className="container mx-auto p-6 sm:p-12">
          ...
          <div className="h-full sm:h-80 text-center flex flex-col sm:flex-row gap-5 sm:gap-20 max-w-full justify-center my-20">
            <div className="bg-white rounded-lg shadow-lg p-6 sm:w-1/2 sm:h-80 sm:py-12">
              ...
              <div className="mt-6 sm:my-10">
                <Link to="/JoinQuiz" className="bg-[#f28482] hover:bg-[#bc4749] text-white font-bold py-3 px-6 rounded-md transition duration-300 ease-in-out">Join Quiz</Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 sm:w-1/2 sm:h-80 sm:py-12">
              ...
              <div className="mt-6 sm:my-10">
                <Link to="/CreateQuiz" className="bg-[#f28482] hover:bg-[#bc4749] text-white  font-bold py-3 px-6 rounded-md transition duration-300 ease-in-out">Create Quiz</Link>
              </div>
            </div>
          </div>
          <div className="h-full sm:h-40 text-center flex flex-col sm:flex-row gap-5 sm:gap-20 max-w-full justify-center my-20">
            <div className="bg-white rounded-lg shadow-lg p-6 sm:w-1/2 sm:py-7">
              ...
              <div className="mt-6 sm:my-10">
                <Link to="/CreatedQuizes" className="bg-[#f28482] hover:bg-[#bc4749] text-white  font-bold py-3 px-6 rounded-md transition duration-300 ease-in-out">Created</Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 sm:w-1/2 sm:py-7">
              ...
              <div className="mt-6 sm:my-10">
                <Link to="/JoinedQuizes" className="bg-[#f28482] hover:bg-[#bc4749] text-white  font-bold py-3 px-6 rounded-md transition duration-300 ease-in-out">Joined</Link>
              </div>
            </div>
          </div>
        </div>
