    ...
    return (
        <div className='min-h-screen my-5'>
            <form className="max-w-sm mx-auto" onSubmit={saveData}>
                ...
                <button type="submit" className="text-white bg-[#f28482] hover:bg-[#bc4749]  focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Save</button>
            </form>
            <ToastContainer />
        </div>
    )
