  ...
  return (
    <>
      {edit ? (
        ...
        <div className="flex justify-center bg-[#f67e7d] min-h-screen">
          <div className='mt-12 w-4/5 sm:w-3/5'>
            <div className="bg-white overflow-hidden shadow rounded-lg border w-full">
              ...
              <div className='text-right py-3 px-5'>
                <button onClick={() => setEdit(true)} className=' bg-[#f28482] hover:bg-[#bc4749] text-whitefont-bold py-2 px-8 rounded-md transition duration-300 ease-in-out' >Edit</button>
              </div>
            </div>
